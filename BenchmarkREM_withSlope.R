...
REM_Simple_stan= stan_model("RandomEffectModel_withSlope_Simple.stan")
REM_SS_stan= stan_model("RandomEffectModel_withSlope_SufficientStatistics.stan")
...
benchmarktREM_N100<-microbenchmark(
  REM_simple <- rstan::sampling(REM_Simple_stan, stan_data, iter=N_warmup+N_MCMC, warmup=N_warmup, chains = 1,
                                 cores = 1, seed = 123 ),
  REM_BRMS <- rstan::sampling(REM_BRMS_stan, stan_data, iter=N_warmup+N_MCMC, warmup=N_warmup, chains = 1,
                               cores = 1, seed = 123 ),
  REM_SS <- rstan::sampling(REM_SS_stan2, stan_data, iter=N_warmup+N_MCMC, warmup=N_warmup, chains = 1,
                             cores = 1, seed = 123 ),
  times=10
...
benchmarktREM_N300<-microbenchmark(
  REM_simple <- rstan::sampling(REM_Simple_stan, stan_data, iter=N_warmup+N_MCMC, warmup=N_warmup, chains = 1,
                                cores = 1, seed = 123 ),
  REM_BRMS <- rstan::sampling(REM_BRMS_stan, stan_data, iter=N_warmup+N_MCMC, warmup=N_warmup, chains = 1,
                              cores = 1, seed = 123 ),
...
benchmarktREM_N1000<-microbenchmark(
  REM_simple <- rstan::sampling(REM_Simple_stan, stan_data, iter=N_warmup+N_MCMC, warmup=N_warmup, chains = 1,
                                cores = 1, seed = 123 ),
  REM_BRMS <- rstan::sampling(REM_BRMS_stan, stan_data, iter=N_warmup+N_MCMC, warmup=N_warmup, chains = 1,
                              cores = 1, seed = 123 ),
