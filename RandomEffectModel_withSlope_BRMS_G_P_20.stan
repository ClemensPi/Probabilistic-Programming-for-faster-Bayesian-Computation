...
transformed parameters {
  ...
  r_1_20 = r_1[, 20];
  r_1_21 = r_1[, 21];
  lprior += student_t_lpdf(Intercept | 3, 0.5, 6.4);
  lprior += student_t_lpdf(sigma | 3, 0, 6.4)
    - 1 * student_t_lccdf(0 | 3, 0, 6.4);
  lprior += student_t_lpdf(sd_1 | 3, 0, 6.4)
    - 21 * student_t_lccdf(0 | 3, 0, 6.4);
