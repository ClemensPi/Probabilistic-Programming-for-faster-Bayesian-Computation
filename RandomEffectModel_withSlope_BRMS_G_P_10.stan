...
transformed parameters {
  ...
  r_1_10 = r_1[, 10];
  r_1_11 = r_1[, 11];
  lprior += student_t_lpdf(Intercept | 3, 0.6, 5.3);
  lprior += student_t_lpdf(sigma | 3, 0, 5.3)
    - 1 * student_t_lccdf(0 | 3, 0, 5.3);
  lprior += student_t_lpdf(sd_1 | 3, 0, 5.3)
    - 11 * student_t_lccdf(0 | 3, 0, 5.3);
